<?php
    ...
    /**
    * @author    joombig http://www.joombig.com
    * @copyright Copyright (C) 2010 - 2013 joombig
    * @license   http://www.joombig.com
    */
    ...
    class JFormFieldAnimation extends JFormField {
        ...
        protected function getInput()
        {
            ...
            $tmpl = JPATH_SITE.'/modules/mod_beautiful_banner_slideshow/tmpl';
                    ...
                    foreach( $xml->files->admin->filename as $file)
                    {
                        if( isset($file['type']) and $file['type']=='javascript' )
                        {
                            if( isset($file['source']) and $file['source']=='external')
                            {
                                ...
                                $doc->addScript(    JURI::root(true).'/modules/mod_beautiful_banner_slideshow/tmpl/'.$folder.'/'.$file );
                            }
                        }  
                        ...
                        if( isset($file['type']) and $file['type']=='stylesheet' ){
                            ...
                            if( isset($file['source']) and $file['source']=='external')
                            {
                                ...
                                $doc->addStyleSheet( JURI::root(true).'/modules/mod_beautiful_banner_slideshow/tmpl/'.$folder.'/'.$file );
                            }
                        }
                    }
                }
